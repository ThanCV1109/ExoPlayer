...
public class PlayerActivity extends Activity implements OnClickListener, ExoPlayer.EventListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        retryButton = (ImageView) findViewById(R.id.retry_button);
        ...
        zoomButton = (ImageView) findViewById(R.id.zoom);
        frameLayout = (FrameLayout) findViewById(R.id.abc);
        ...
        if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
            ...
            zoomButton.setImageResource(R.drawable.pull_screen);
        } else {
            height = displaymetrics.heightPixels;
            zoomButton.setImageResource(R.drawable.fullscreen);
        }
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        //frameLayout.setVisibility(newConfig.orientation == Configuration.ORIENTATION_PORTRAIT
